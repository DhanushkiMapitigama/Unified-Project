...
void SendMessage()
{
  ...
  mySerial.println("AT+CMGS=\"+94776393272\"\r"); // Replace x with mobile number
  delay(1000);
...
void MakeCall()
{
  mySerial.println("ATD+94776393272;"); // ATDxxxxxxxxxx; -- watch out here for semicolon at the end!!
